...
int main()
{
    const char table_name[100] = "results";
    // int raceId;
    // int driverId;
    // int constructorId;
    // int number;
    ...
    while ((m = 5))
    {
        ...
        else if (answer1a == 2)
        {
            ...
            printf("Insert into positionOrder?\n>>> ");
            ...
            printf("Insert into fastestLap?\n>>> ");
            scanf("%d", &fastestLap);
            sleep(1);

            printf("Insert into rank?\n>>> ");
            scanf("%d", &rank);
            sleep(1);

            printf("Insert into fastestLapTime?\n>>> ");
            scanf("%s", fastestLapTime);
            sleep(1);

            printf("Insert into fastestLapSpeed?\n>>> ");
